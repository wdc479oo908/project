<?php
	...
	$insertSql = "INSERT INTO poster (accountName,class,postId,postDate,picture,title,good,dislike,context,nickname,status) VALUES ('$accountName','$class','$postId','$postDate','$picture','$title','$good','$dislike','$context','$nickname',0)";
