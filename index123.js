...
$(document).ready(function() {
    ...
    $('#t1').click(function() {
        ...
        if (class1 == 'all') $('#s2').text("所有看板");
        else if (class1 == 'emotion') $('#s2').text("感情看板");
        else if (class1 == 'game') $('#s2').text("電玩看板"); 
        else if (class1 == 'sport') $('#s2').text("運動看板"); 
        else if (class1 == 'food') $('#s2').text("美食看板"); 
        else if (class1 == 'schoolwork') $('#s2').text("課業看板"); 
        else if (class1 == 'politics') $('#s2').text("政治看板"); 
        else if (class1 == 'others') $('#s2').text("其它看板"); 
        load1();
    });
